...
class ControllerAccountOrder extends Controller {
	...
	public function info() {
		...
		if ($order_info) {
			...
			$data['attachments'] = $this->model_account_order_attachment->getAttachments($this->request->get['order_id'], $this->customer->getId());
			$data['attachment_count'] = count($data['attachments']);
			$data['attachment_link'] = $this->url->link('account/order_attachment', 'order_id=' . $this->request->get['order_id'], true);
