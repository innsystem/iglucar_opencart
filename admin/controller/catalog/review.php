...
class ControllerCatalogReview extends Controller {
	...
	public function toggleStatus() {
		...
		if ($this->request->server['REQUEST_METHOD'] == 'POST' && isset($this->request->post['review_id']) && isset($this->request->post['status'])) {
			$this->load->model('catalog/review');
			...
			$this->model_catalog_review->updateReviewStatus($review_id, $new_status);
