...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'catalog/import_export')) {
				$catalog[] = array(                    
					'name'     => 'Importar/Exportar',
					'href'     => $this->url->link('catalog/import_export', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'catalog/about')) {
				$catalog[] = array(
					...
					'href'     => $this->url->link('catalog/about', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}

			if ($this->user->hasPermission('access', 'catalog/mural_credibilidade')) {
				$catalog[] = array(
					'name'	   => 'Mural da Credibilidade',
					'href'     => $this->url->link('catalog/mural_credibilidade', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
