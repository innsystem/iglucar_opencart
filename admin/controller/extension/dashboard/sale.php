...
class ControllerExtensionDashboardSale extends Controller {
	...
	public function dashboard() {
		...
		$today = $this->model_extension_dashboard_sale->getTotalSales(array('config_complete_status' => $config_complete_status, 'filter_date_added' => date('Y-m-d', strtotime('-1 day'))));

		$yesterday = $this->model_extension_dashboard_sale->getTotalSales(array('config_complete_status' => $config_complete_status, 'filter_date_added' => date('Y-m-d', strtotime('-2 day'))));
		...
		$sale_total = $this->model_extension_dashboard_sale->getTotalSales(array('config_complete_status' => $config_complete_status));
